...
const (
	...
	LstdFlagsLong  = Ldate | Ltime | Lmicroseconds // initial values for the standard logger
	LstdFlagsShort = Ldate | Ltime
	Ldefault       = Lmodule | Llevel | Lshortfile | LstdFlagsShort
